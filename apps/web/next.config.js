...
const ContentSecurityPolicy = [
  ...
  // WebSocket до свого сервера + текстури з CDN
  "connect-src 'self' ws://localhost:4000 wss://localhost:4000 wss://*.sessionmap.app https://unpkg.com https://cdn.jsdelivr.net",
